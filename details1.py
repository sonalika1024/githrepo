...
build_files = ['Makefile', 'build.gradle', 'pom.xml', 'package.json']
print('\nBuild Tools:')
...
test_files = ['pytest.ini', 'setup.cfg', 'tox.ini', 'package.json']
print('\nTesting Tools:')
...
db_files = ['config.yaml', 'settings.py', 'application.properties']
print('\nDatabases:')
